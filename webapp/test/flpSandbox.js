		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP UI5",
									"targetURL": "#deloittetrainingsapui5ap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"deloittetrainingsapui5ap-display": {
								"semanticObject": "deloittetrainingsapui5ap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=deloitte.training.sapui5ap",
									"url": sap.ui.require.toUrl("deloitte/training/sapui5ap")
								}
							}
						}
					}
